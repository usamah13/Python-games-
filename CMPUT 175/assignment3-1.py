...
def main():
    ...
    try:
        ...
        while not endGame:
            ...
            print(cardsonTable)
            print("PLAYER CARDS 1: " + str(player1cards))
            print("PLAYER CARDS 2: " + str(player2cards))
            print(player1cards.size()) 
            print(player2cards.size())
                   ...
                   # END GAME PLAYER 1 WINs
                    if player2cards.size() > facedownnumber:
                        ...
                        while i < facedownnumber:
                            ...
                            i = i + 1
                    elif player2cards.size() < facedownnumber:
                        cardsWar = cardsonTable.cleanTable()
                        for item in cardsWar:
                            player1cards.enqueue(item)
