...
def main():
	...
	for line in fileLines:
		...
		if data['region'] in earthQuakeDict:
			earthQuakeDict[data['region']] = earthQuakeDict[data['region']] + ", " + dateMagnitudeMappingString
		else:
			earthQuakeDict[data['region']] = dateMagnitudeMappingString

	print("The Dictionary")
	print (earthQuakeDict)
	print(' ')
	print("Output after processing the dictionary")
	for key in earthQuakeDict:
		print ("[" + key + ", " + earthQuakeDict[key] + "]")
