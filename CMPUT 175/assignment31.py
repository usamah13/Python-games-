...
def compare_cards(card1,card2):
    ...
    for card in twocards:
        ...
        elif card1[firstchar] == '7':
            cardsrank.append(5) 
            
        elif card1[firstchar] == '6':
            cardsrank.append(4)      
...
class onTable:
    ...
    def place(self,player,card,hidden):
        ...
        if player == 1 and hidden == False:
            ...
            self.cards_list.insert(left,hiddenstr)
            self.face_uplist.insert(left, hidden)    
            
        elif player == 2  and hidden == True:
            self.cards_list.append(hiddenstr)
            self.face_uplist.append(hidden)   
    ...
    def cleanTable(self):
        ...
        shuffling = True 
        if shuffling:
            a = list(range(len(self.cards_list)))
            random.shuffle(a)
            self.cards_list = self.cards_list[a]
            self.cards_list = self.cards_list[a]
            shuffling = False 
...
def main():
    ...
    try:
        ...
        while not endgame:
            ...
            print(cardsonTable)
            print('Player : ' +str(player1cards.size()))
            comaprsion = compare_cards(faceupcard1,faceupcard2)
